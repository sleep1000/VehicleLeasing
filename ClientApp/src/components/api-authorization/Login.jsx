...
const login = async function (returnUrl, setState) {
...
const processLoginCallback = async function (setState) {
...
const redirectToApiAuthorizationPath = function (apiAuthorizationPath) {
